...
public class CodeGenerator {
    private static final String JDBC_URL = "jdbc:mysql://mysql.duia.com:3306/mars";
    private static final String JDBC_USERNAME = "mars";
    private static final String JDBC_PASSWORD = "Amars_993120(qq)m";
    ...
    private static final String BASE_PACKAGE = "com.duia.commodity";//项目基础包名称
