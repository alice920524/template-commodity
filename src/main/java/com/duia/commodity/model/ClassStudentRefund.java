...
@Table(name = "class_student_refund")
public class ClassStudentRefund implements Serializable {
    @Id
     ...
     * 获取退款协议ID
     *
     * @return aggrement_template_id - 退款协议ID
     */
     ...
     * 设置退款协议ID
     *
     * @param aggrementTemplateId 退款协议ID
     */
