 ...
 */
@Service("payOrderNBackSPProxyServiceImpl")
public class PayOrderNBackSPProxyServiceImpl extends PayOrderNBackProxyServiceImpl implements PayOrderProxyService {
