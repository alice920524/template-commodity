 ...
 */
@Service("payOrderNBackUPProxyServiceImpl")
public class PayOrderNBackUPProxyServiceImpl extends PayOrderNBackProxyServiceImpl implements PayOrderProxyService {
